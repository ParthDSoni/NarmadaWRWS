...
{
    public class CMVideoController : Controller
    {
        ...
        public CMVideoController(IVideoMasterServices _objVideoMasterServices)
        {
        ...
        [HttpPost]
        [Route("/GetCMVideo")]
        public async Task<JsonResult> GetCMVideo(long department, string? title, DateTime? date, DateTime? date1, int currentPage)
        {
        ...
        [Route("/CMVdeoGallery")]
        public IActionResult CMVideoGallery()
        {     
            return View();
        }
