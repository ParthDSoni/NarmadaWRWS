$(document).ready(function () {
    ...
    BindPressSlider(null, null, null, null, 1);
...
$('#DepartmentId').change(function () {
    ...
    var date = $('#date').val();
    var date1 = $('#date1').val();
    BindPressSlider(DepartmentId, DistrictId, date, date1, 0);
});
...
function BindPressReleasesGrid() {
    ...
    var token = $('input[name="AntiforgeryFieldname"]').val();
    $.ajax({
        type: "POST", url: ResolveUrl("/PressReleaseDetailsData"),
...
function BindPressSlider(DepartmentId, DistrictId, date, date1, isFirstTime) {
    var token = $('input[name="AntiforgeryFieldname"]').val();
