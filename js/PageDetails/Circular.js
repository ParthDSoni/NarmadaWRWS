...
$("#SearchTR").click(function (e) {
    var CircularData = $('#CircularSearchParam').val();
    BindCircularGrid(CircularData);
});

$("#SearchClear").click(function (e) {
    $('#CircularSearchParam').val("");
    BindCircularGrid();
});

function BindCircularGrid(CircularData = '') {
    ...
    $("#tableDV").DataTable({
        ...
        "ajax": {
            "type": "POST",
            "url": ResolveUrl("/BindCircularGrid"),
            "contentType": "application/x-www-form-urlencoded",
            "data": { "CircularSearchParam": CircularData, "AntiforgeryFieldname": token },
            "dataType": "json",
