    ...
    public class GoiLogoService : IGoiLogoServices
    {
        ...
        public JsonResponseModel Delete(long id, string username)
        {
            ...
            try
            {
                ...
                dapperConnection.GetListResult<AdminMenuMasterModel>("RemoveGoiLogoMaster", CommandType.StoredProcedure, dictionary).ToList();
        ...
        public List<GoiLogoModel> GetList(long lgLangId = 1)
        {
            try
            {
                ...
                var data = dapperConnection.GetListResult<GoiLogoModel>("GetAllGoiLogoMasterLanguageId", CommandType.StoredProcedure, dictionary).ToList();
                data.ForEach(x => {
                    x.Id = (long)x.Id;
                });
                return data;
        ...
        public JsonResponseModel AddOrUpdate(GoiLogoModel model, string username)
        {
            ...
            {                
                ...
                var data = dapperConnection.GetListResult<long>("InsertOrUpdateGoiLogoMaster", CommandType.StoredProcedure, dictionary).FirstOrDefault();
